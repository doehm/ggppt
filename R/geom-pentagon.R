...
#'
#' @rdname pentagon
stat_pentagon <- function(mapping = NULL, data = NULL,
...
#' library(ggplot2)
#' library(dplyr)
geom_pentagon <- function(mapping = NULL, data = NULL, stat = "pentagon",
