...
#'
#' @rdname callout
stat_callout <- function(mapping = NULL, data = NULL,
...
StatCallout <- ggplot2::ggproto(
  ...
  compute_panel = function(data, scales, angle = params$angle, pos = params$pos,
                           length = params$length, rotate_at = params$rotate_at) {

    dat_out <- make_callout(
...
#' library(ggplot2)
#' library(dplyr)
geom_callout <- function(mapping = NULL, data = NULL, stat = "callout",
