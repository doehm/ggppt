...
#'
#' @rdname diamond
stat_diamond <- function(mapping = NULL, data = NULL,
...
#'    from a `formula` (e.g. `~ center(.x, 10)`).
...
#' library(ggplot2)
#' library(dplyr)
geom_diamond <- function(mapping = NULL, data = NULL, stat = "diamond",
                         position = "identity", na.rm = FALSE,
                         show.legend = NA, inherit.aes = TRUE,
                         angle = 0, rotate_at = "center", ...) {
